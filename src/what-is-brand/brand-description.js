      ...
      <div className="container mx-auto sm:px-5">
        <div className="banner-content md:flex items-center text-left mt-10 mb-10 gap-10">
            <div className="md:w-1/2">
              ...
              <div className="md:w-1/2">
                  <h2 className="md:text-[50px] text-[#414041] font-light">What is <span className='text-blue-700 font-bold uppercase '>Brand Name</span></h2>
...
export default LucaDescription;
